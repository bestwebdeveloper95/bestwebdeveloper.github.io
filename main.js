...
const servicesData = [
    ...
    { 
        ...
        detail: 'Без учёта стоимости колодок • зависит от местонахождения'
    },
    { 
        icon: '🔧', 
        ...
        price: '1500–3000 ₽/шт', 
        desc: 'Для ТС массой до 2500 кг',
        detail: 'Без учёта стоимости амортизаторов • зависит от местонахождения'
    },
    { 
        icon: '🛢️', 
        ...
        price: '1200–2000 ₽', 
        desc: 'Двигатель',
        detail: 'Без учёта стоимости масла и фильтра • зависит от местонахождения'
    },
    { 
        icon: '⚙️', 
        ...
        detail: 'Без учёта стоимости масла • зависит от местонахождения'
    },
    { 
        icon: '🔩', 
    ...
    { 
        ...
        detail: 'Без учёта стоимости ремня • зависит от местонахождения'
    },
    { 
        icon: '🌀', 
        ...
        price: '2000–3000 ₽', 
        desc: 'Для ТС массой до 2500 кг',
        detail: 'Без учёта стоимости подшипника • зависит от местонахождения'
    },
    { 
        icon: '🔗', 
        ...
        price: '1500–2000 ₽', 
        desc: 'Для ТС массой до 2500 кг',
        detail: 'Без учёта стоимости наконечников • зависит от местонахождения'
    }
];
